...
public class DaretController {
    ...
    public ResponseEntity store(@RequestHeader("Authorization") String token,@Valid @RequestBody StoreDaretRequest request){
    ...
    public ResponseEntity updaEntity(@RequestHeader("Authorization") String token,@PathVariable long id,@Valid @RequestBody StoreDaretRequest request) {
        Map<String, Object> result = new HashMap<>();
